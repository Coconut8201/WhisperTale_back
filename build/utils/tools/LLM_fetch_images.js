...
const GenImg_prompt_En = (story_slice, storyRoleForm) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const GenImg_prompt_En_array = (story_array, storyRoleForm) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        for (let i = 0; i < story_array.length; i++) {
            ...
            console.log(`第 ${i} 次生成`);
            generated_imageprompt_array.push(yield (0, exports.GenImg_prompt_En)(story_slice, storyRoleForm));
        }
