...
// 生成故事內容
const generateStory = (storyRoleForm, voiceModelName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let Saved_storyID = yield (0, LLMapi_1.LLMGenStory_1st_2nd)(storyRoleForm, Response);
        if (!Saved_storyID) {
